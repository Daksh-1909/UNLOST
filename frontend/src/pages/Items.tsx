...
const Items: React.FC = () => {
 ...
 <div className="glass-panel rounded-xl p-16 text-center text-textSecondary border border-dashed border-primary/20 bg-primary/5">
 ...
 {verifying ? (
 <>
 <div className="h-4 w-4 animate-spin rounded-xl border-2 border-primary border-t-transparent"></div>
