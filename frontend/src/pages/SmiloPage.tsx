...
const SmiloPage: React.FC = () => {
 ...
 return (
 <div className="w-full flex justify-center mt-12 sm:mt-16" style={{ height: 'calc(100vh - 240px)' }}>
 <div 
 className="flex flex-col w-full max-w-6xl h-full rounded-2xl overflow-hidden shadow-2xl bg-surface/95 border border-primary/10 backdrop-blur-xl"
 >
 {/* Header */}
 <div className="flex items-center justify-between p-4 border-b border-primary/10 bg-primary/5">
 <div className="flex items-center gap-3">
 <div className="w-3 h-3 rounded-xl bg-green-400 shadow-[0_0_10px_#4ade80]" />
 ...
 ${msg.sender === 'user' ? 'rounded-xl rounded-tr-sm btn-primary-custom' : 'rounded-xl rounded-tl-sm bg-primary/5 border border-primary/10'}
 ...
 <div className="p-4 rounded-xl rounded-tl-sm bg-primary/5 border border-primary/10 flex gap-1.5 items-center">
 {[0, 1, 2].map((idx) => (
 <div 
 key={idx} 
 className="w-1.5 h-1.5 rounded-xl bg-accent animate-pulse"
 ...
 className="text-xs px-4 py-2 rounded-xl bg-primary/5 border border-primary/10 text-textSecondary hover:bg-primary/10 transition-colors focus:outline-none"
 >
 {s.label}
 </button>
 ))}
