...
const Navbar: React.FC = () => {
 ...
 <Link to="/profile" onClick={() => setIsDropdownOpen(false)} className="flex items-center px-4 py-2 text-sm text-textSecondary hover:text-primary hover:bg-white/5 transition-colors">
 ...
 <Link to="/profile" onClick={() => setIsOpen(false)} className="flex items-center px-3 py-3 rounded-lg text-sm font-medium text-textSecondary hover:text-text hover:bg-white/5 transition-colors">
 <User className="mr-3 h-4 w-4" /> Profile
 </Link>
 <button
