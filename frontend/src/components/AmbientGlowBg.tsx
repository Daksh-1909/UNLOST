...
export const AmbientGlowBg: React.FC<AmbientGlowBgProps> = ({ children, className = '' }) => {
  return (
    <div className={`relative w-full h-full overflow-x-hidden ${className}`}>
      ...
      <div className="absolute top-[600px] left-1/2 -translate-x-1/2 w-[120%] max-w-5xl h-[400px] bg-primary/20 dark:bg-primary/30 rounded-full blur-[120px] opacity-30 pointer-events-none -z-10"></div>
